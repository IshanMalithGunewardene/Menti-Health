...
public class MoodTrackerActivity extends AppCompatActivity {
    ...
    private String userName; // Make name a class-level variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userName = getIntent().getStringExtra("NAME"); // Store in class-level variable
        ...
        btnMoveForward.setOnClickListener(v -> {
            ...
            if (saved) {
                ...
                intent.putExtra("NAME", userName); // Now using class-level variable
